...
- 🔧 支持 Minecraft 26.2 全新渲染管线（RenderPipeline）
...
| Mod | 版本 | 说明 |
|-----|------|------|
| Fabric API | 0.156.0+26.2 | 必需 |
| Cloth Config | 26.2.155 | 配置界面必需 |
| ModMenu | 19.0.0-alpha.1 | 可选（推荐，可在模组菜单中配置） |

### 安装步骤

1. 安装 [Fabric Loader](https://fabricmc.net/use/) 0.18.6+
2. 将 `portal-preview-2.0.0.jar` 放入 `.minecraft/mods/` 文件夹
3. 安装 Fabric API 0.156.0+26.2
4. 安装 Cloth Config 26.2.155（配置界面必需）
5. （可选）安装 ModMenu 19.0.0-alpha.1
6. 启动游戏，享受地狱门预览功能！
...
- 由于 26.2 渲染系统为全新架构，预览渲染效果可能与旧版略有差异
