...
[![Fabric](https://img.shields.io/badge/Fabric%20Loader-%3E%3D0.18.0-9d4edd.svg)](https://fabricmc.net/)
[![Java](https://img.shields.io/badge/Java-%3E%3D25-F89820.svg)](https://www.oracle.com/java/)
...
- 🔧 支持 Minecraft 26.1 全新渲染管线（RenderPipeline）
...
| ModMenu | 18.0.0-alpha.8 | 可选（推荐，可在模组菜单中配置） |

### 安装步骤

1. 安装 [Fabric Loader](https://fabricmc.net/use/) 0.18.6+
...
如遇到 Bug 或有功能建议，欢迎通过项目的 Issue 页面反馈。
